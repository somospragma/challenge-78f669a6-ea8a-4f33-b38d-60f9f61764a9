...
// === ARCHIVO: src/main/java/com/fintech/app/App.java ===
package com.fintech.app;

public class App {
    public static void main(String[] args) {
        System.out.println("Appium Mobile Test Automation");
    }
}

// === ARCHIVO: src/test/java/com/fintech/app/tests/FunctionalTest.java ===
